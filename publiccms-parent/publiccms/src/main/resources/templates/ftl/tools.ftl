...
<#macro merge valuename value><#if !.vars[valuename]??><@"<#assign ${valuename}=''>"?interpret /></#if><#if value?has_content><@"<#assign ${valuename}=${valuename}+'${value?js_string},'>"?interpret /></#if></#macro>
<#macro clear name><@"<#assign ${name}=''>"?interpret /></#macro>
